...
def skuddår(årstall: int):
    # 2. Lag funksjonen
    if årstall % 400 == 0: # hvis årstallet del på 400 gir 0 i rest:
        return True
    elif årstall % 4 == 0 and årstall % 100 != 0:   # % = delt på  
    # hvis årstallet delt på 4 gir 0 i rest OG årstallet delt på 100 IKKE gir 0 i rest:
        return True
    else:
        return False
